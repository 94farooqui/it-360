  ...
  return (
    <div className="bg-card rounded-lg shadow-sm border">
      <div className="px-8 pt-8 pb-4">
        <h2 className="text-2xl font-semibold text-primary">{asset.assetName}</h2>
        <p className="text-sm text-slate-500 mt-2">{asset.description}</p>
      </div>
      <hr/>
      <div className="grid grid-cols-1 gap-y-2 lg:grid-cols-3 text-sm text-slate-500 px-8 py-4">
        ...
        <div className="col-span-3 border-t px-8 text-sm text-slate-500 py-4">
          <p className="font-semibold text-lg text-primary">Vendor</p>
          <div className=" mt-2 grid grid-cols-1 gap-y-2 lg:grid-cols-2">
