...
const TicketDetail = ({ ticket}) => {
  ...
  //const {ticket,setticket} = useContext(RootContext)
  ...
  return (
    <div className="w-full h-full grid grid-cols-[auto_350px] gap-x-4">
      <div className="flex flex-col gap-4 overflow-y-scroll pl-4 py-4">
        <Card className="flex flex-col gap-2 justify-between item-center bg-primary-foreground card p-4">
          <p className="text-gray-400 font-semibold">TK-200</p>
        ...
        <div className="">
          ...
          <Card className="flex flex-col gap-4 justify-between item-center bg-primary-foreground card p-4">
            ...
            <p className="text-primary/60">{ticket.asset.description}</p>
      ...
      <div className="sticky h-full flex flex-col justify-between border-l-2 pl-4 border-dashed py-4 border-gray-300">
