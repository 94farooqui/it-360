...
const Login = () => {
  ...
  const { token, login,loading, setLoading} = useContext(AuthContext);
      ...
      <div className="w-[1000px] bg-white rounded-xl shadow-md flex overflow-hidden">
        ...
        <div className="flex-1 py-12 px-8 flex flex-col items-start">
          ...
          <form
            ...
            className="w-full mt-4 flex flex-col gap-4 text-lg"
          >
            <input
              name="username"
            ...
            <button
              type="submit"
              className="p-2 text-lg font-semibold text-slate-100 bg-slate-950 rounded-lg self-start px-8 "
            >
